...
const areas = [
  ...
  ['local-base', "We're here", '', 'Our local base within the area we work in. Consultations take place at your home.', '/about/', 'About Kensington Bathrooms']
];
...
<section class="map-reading" id="kensington" aria-labelledby="map-reading-title"><div class="map-reading__inner"><div class="map-reading__lead"><p class="map-reading__kicker">Kensington Bathrooms</p><h2 id="map-reading-title">Bathroom renovation in Kensington, from first visit to final clean</h2></div><div class="map-reading__blocks">
  ...
  <article><span class="map-reading__number">02</span><div><h3>One connected area, different homes</h3><p>We work across Kensington W8, West Kensington, Holland Park, South Kensington and Chelsea. The buildings differ, from stucco houses and mews to portered flats and mansion blocks. On the first visit we talk through the room and the building together, including services, access and any rules that may affect the work.</p><a href="/areas/">Explore the areas we serve <span aria-hidden="true">↗</span></a></div></article>
