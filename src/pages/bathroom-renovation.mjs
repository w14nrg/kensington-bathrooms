...
<section class="page-hero page-hero--photo">
  <div class="page-hero__inner page-hero__inner--split">
    <div class="page-hero__copy">
      ...
      <p class="page-hero__lede">Tell us how you want to use the room. Nick visits, talks through what you have in mind and looks at what the property can support before a design becomes a specification.</p>
