...
${areaHero({ name:'West Kensington', postcodes:'W14', kicker:'Close to our local base', lede:'We work in West Kensington, near our local base. The first visit starts with the room you have and the services behind it, whether your home is a house, conversion or purpose-built flat.' })}
...
${areaCards({ eyebrow:'At your home', title:'Two questions before choosing the fittings.', cards:[
...
${areaClose('West Kensington','West Kensington is one of the neighbourhoods where we work. Our local base is nearby, and a consultation takes place at your home rather than at a walk-in showroom.')}`; }
